  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 dark:border-slate-800 dark:focus:ring-slate-300",
  {
    variants: {
      variant: {
        ...
        periwinkle: "border-periwinkle-400/30 bg-periwinkle-500/10 text-periwinkle-300",
        success: "border-emerald-500/30 bg-emerald-500/10 text-emerald-400 dark:text-emerald-300",
        warning: "border-amber-500/30 bg-amber-500/10 text-amber-500 dark:text-amber-300",
        danger: "border-red-500/30 bg-red-500/10 text-red-400 dark:text-red-300",
      },
    },
    defaultVariants: {
      variant: "default",
